...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { credential: @visitor.credential, email: @visitor.email, name: @visitor.name, schedule_id: @visitor.schedule_id } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { credential: @visitor.credential, email: @visitor.email, name: @visitor.name, schedule_id: @visitor.schedule_id } }
